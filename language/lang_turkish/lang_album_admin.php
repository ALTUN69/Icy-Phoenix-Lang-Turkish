...
// 01 - Configuration
	'Album_config' => 'Albüm',
	'Album_config_explain' => 'Buradan Fotoğraf Albümü ayarlarını değiştirebilirsiniz.<br />',
	'Album_config_updated' => 'Albüm Ayarları başarıylan güncellendi',
	'Click_return_album_config' => 'Albüm Ayarlarına dönmek için %sBuraya%s tıklayın',
	'Max_pics' => 'Her kategori için en fazla resim sayısı (-1 = sınırsız)',
	'User_pics_limit' => 'Her kullanıcı için kategori başına Resim sınırı (-1 = sınırsız)',
	'Moderator_pics_limit' => 'Her moderatör için kategori başına Resim sınırı (-1 = sınırsız)',
	'Pics_Approval' => 'Resimler Onayı',
	'Rows_per_page' => 'Küçük resim sayfasında satır sayısı',
	'Cols_per_page' => 'Küçük resim sayfasında sütun sayısı',
	'Thumbnail_quality' => 'Küçük resim kalitesi (1-100)',
	'Thumbnail_cache' => 'Küçük resim önbelleği',
	'Manual_thumbnail' => 'Elle küçük resim',
	'GD_version' => 'GD sürümü için en uygun hale getirme',
	'Pic_Desc_Max_Length' => 'Resim Açıklaması/En fazla yorum uzunluğu (bayt)',
	'Hotlink_prevent' => 'Direkt Bağlantı Engelleme',
	'Hotlink_allowed' => 'Direkt bağlantı için izin verilen alanlar (virgül ile ayrılır)',
	'Personal_gallery' => 'Kullanıcılar için kişisel galeri oluşturma izni',
	'Personal_gallery_limit' => 'Her kişisel galeri için resim sınırı (-1 = sınırsız)',
	'Personal_gallery_view' => 'Varsayılan kişisel galerileri kimler görebilir',
	'Rate_system' => 'Derecelendirme sistemini etkinleştir',
	'Rate_Scale' => 'Derecelendirme Ölçeği',
	'Comment_system' => 'Yorum sistemini etkinleştir',
	'Thumbnail_Settings' => 'Küçük Resim Ayarları',
	'Quick_Thumbnails' => 'Hızlı Küçük Resimler',
	'Quick_Thumbnails_explain' => 'Önceden oluşturulmuş olan küçük resimi, bir sistem kontrolü için bu seçeneği etkinleştirin ve tarayıcıya doğrudan göndermeyi deneyin. Kategorileri görüntülerken bu küçük resim üreticisi hızlandırır.',
	'Extra_Settings' => 'İlave Ayarlar',
