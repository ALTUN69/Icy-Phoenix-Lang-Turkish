...
<br />
<br />
<span style="color: #dd2222;"><b>Muhammet ALTUN</b></span><br />
<b><i>Turkish Translator</i></b><br />
<br />
<br />
...
$lang = array_merge($lang, array(
	...
	'Select_forum' => 'Forum seçin',
	'View_latest_post' => 'Son mesajı görüntüle',
	'View_newest_post' => 'Yeni mesajı görüntüle',
	'Page_of' => 'Sayfa <b>%d</b> ile <b>%d</b> arasında', // Replaces with: Page 1 of 2 for example
...
// Global Header strings
	...
	'Browsing_forum' => 'Bu forumu görüntüleyen kullanıcılar:',
	...
	'AC_Online_users_zero_total' => 'Toplam <b>0</b> kullanıcı sohbetde: ',
	'AC_Online_users_total' => 'Toplam <b>%d</b> kullanıcı sohbette: ',
	'AC_Online_user_total' => 'Toplam <b>1</b> kullanıcı sohbette: ',
	...
	'Record_online_users' => 'Bugüne kadar en çok <b>%s</b> kullanıcı %s tarihinde çevrimiçi oldu', // first %s = number of users, second %s is the date.

	'Admin_online_color' => '%sYönetici%s',
	'Mod_online_color' => '%sModeratör%s',

	'You_last_visit' => 'Son ziyaretiniz %s', // %s replaced by date/time
	'Current_time' => 'Şuan\'ki zaman %s', // %s replaced by time

	'Search_new' => 'Son ziyaretinizden bu yana gönderilen mesajlar',
...
// Stats block text
	'Posted_articles_zero_total' => 'Kullanıcılarımız toplam <b>0</b> mesaj gönderdiler', // Number of posts
	'Posted_articles_total' => 'Kullanıcılarımız toplam <b>%d</b> mesaj gönderdiler', // Number of posts
...
// Login
	'Enter_password' => 'Oturum açmak için kullanıcı adınızı ve şifrenizi giriniz.',
	'Login' => 'Oturum Aç',
	'Logout' => 'Çıkış Yap',
	'Forgotten_password' => 'Şifremi unuttum',
	'AUTOLOGIN' => 'Her ziyaretimde otomatik giriş yap',
	'Error_login' => 'Yanlış ya da pasif kullanıcı adı veya geçersiz bir şifre belirttiniz.',
...
// Posting/Replying (Not private messaging!)
	...
	'New_post_Announcement' => 'Yeni duyuru',
	'Post_Sticky' => 'Sticky',
...
// Private Messaging
	...
	'No_new_pm' => 'Yeni Özel Mesajınız yok',
...
//End Quick Administrator User Options and Information MOD
	...
	'Items_required' => '* İşaretli bölümler aksi belirtilmedikçe gereklidir.',
	'Registration_info' => 'Kayıt Bilgileri',
	'Profile_info' => 'Profil Bilgileri',
	'Profile_info_warn' => 'Bu bilgiler herkez tarafından görülebilecekdir',
...
// Invision View Profile - END
	...
	'Upload_Avatar_file' => 'Cihazınızdan avatar yükleyin',
	'Upload_Avatar_URL' => 'Bir URL\'den Avatar  yükleyin',
	...
	'Avatar_URL' => 'Avatar Resminin URL\'si',
	'Select_from_gallery' => 'Galeri\'den Avatar seçin ',
	'View_avatar_gallery' => 'Galeriyi Göster',

	'Select_avatar' => 'Avatarı Seç',
	'Return_profile' => 'Avatarı İptal Et',
	...
	'Welcome_subject' => '%s Forumlarına Hoşgeldiniz', // Welcome to my.com forums
	'New_account_subject' => 'Yeni kullanıcı hesabı',
	'Account_activated_subject' => 'Hesap aktif hale getirilmiştir',

	'Account_added' => 'Kayıt olduğunuz için teşekkür ederiz. Hesabınız oluşturuldu. Artık kullanıcı adı ve şifreniz ile giriş yapabilirsiniz.',
	'Account_inactive' => 'Hesabınız oluşturuldu. Ancak, bu forum hesap etkinleştirmesi gerektirir. Bir etkinleştirme anahtarı verdiğiniz e-posta adresine gönderildi. Daha fazla bilgi için e-postanızı kontrol edin',
	'Account_inactive_admin' => 'Hesabınız oluşturuldu. Ancak hesabınızın etkin hale gelmesi için yönetici onayı gerekmektedir. Bir e-posta kendilerine gönderildi ve hesabınız etkinleştiğinde size bilgi verilecektir',
	'Account_active' => 'Hesabınız şimdi etkinleştirildi. Kayıt olduğunuz için teşekkür ederiz',
	'Account_active_admin' => 'Hesap artık etkinleştirildi',
	'Reactivate' => 'Hesabınızı yeniden etkinleştirmelisiniz!',
	'Already_activated' => 'Hesabınız zaten etkin durumda',
	'COPPA' => 'Hesabınız oluşturuldu, ancak kabul edilmesi gerekiyor. Bilgi için e-postanızı kontrol edin.',

	'Registration' => 'Kayıt Anlaşma Koşulları',
	'Reg_agreement' => 'Bu forumun yöneticileri ve moderatörleri her nekadar itiraz edilebilecek her türlü materyali mümkün olduğu kadar kısa sürede siteden kaldıracak olsada, bütün mesajların incelenmesi mümkün olmamaktadır. Bu durumda siz buraya gönderilen her mesajın, onu gönderen kullanıcının görüşlerini yansıttığını, moderatörlerin, yöneticilerin ya da webmasterlerin (kendilerine ait mesajlar dışında) sorumlu tutulamayacağını peşinen kabul etmiş bulunuyorsunuz.<br /><br />Aşağılayıcı, müstehcen, kaba, iftira niteliğinde, nefret dolu, tehdit edici, sekse yönelik yada kanunlarla çelişecek içerikler göndermeyeceğinizi kabul ediyorsunuz. Bunları dikkate almamanız durumunda hemen ve süresizce siteden uzaklaştırılırsınız (ve servis sağlayıcınız da haberdar edilir). Her mesajın IP adresi bunları engellemek için kaydedilmektedir. Bu forumun moderatörleri, yöneticileri yada webmasterleri, kendi iradeleri doğrultusunda herhangi bir başlığı silme, taşıma, kilitleme yetkisi olduğunu kabul ediyorsunuz. Bir kullanıcı olarak her girdiğiniz bilginin veritabanında saklanacağını kabul ediyorsunuz. Her ne kadar bu bilgiler sizin bilginiz dışında üçüncü şahıslara verilmeyecek olsa\'da, herhangi bir &quot;<i>hack</i>&quot; olayı sonucunda bu bilgiler üçüncü şahısların eline geçse bundan webmaster, moderatör yada yöneticileri sorumlu tutamazsınız.<br /><br />Bu forum sistemi, bazı bilgileri bilgisayarınızda saklamak için çerezleri kullanmaktadır. Girdiğiniz özel bilgilerin hiçbiri bu çerezlerde bulunmamaktadır, bunların tek amacı forumda daha rahat bir gezinti yapabilmeniz içindir. E-Posta adresiniz sadece kaydınızı onaylamak ve şifrenizi yollamak içindir (Ve unuttuğunuz zaman şifrenizi yeniden yollamak için).<br /><br />Aşağıdaki &quot;<i>Bu şartları kabul ediyorum</i>&quot; linkine basmak sureti ile yukarıdaki bütün koşulların bağlayıcılığını kabul edersiniz. Ayrıca kişisel verileriniz site sahibinin ülkesindeki mevcut yasalara göre muamele göreceğinide unutmayın.<br /><br />',

	'Agreement' => 'Anlaşma',
	'Agree_under_13' => 'Bu koşulları kabul ediyorum ve 13 yaşın <b>altındayım</b>',
	'Agree_over_13' => 'Bu şartları kabul ediyorum',
	'Agree_not' => 'Bu şartları kabul etmiyorum',
	'Agree_checkbox' => 'Ben bu şartları özellikle kabul ediyorum',
	'Agree_checkbox_Error' => 'Kayıt için sayfanın altındaki "SÖZLEŞME" kutusunu kontrol etmeniz gerekir!',

	'Wrong_activation' => 'Girdiğiniz etkinleştirme kodu veritabanındaki ile uyuşmuyor.',
	'Send_password' => 'Bana yeni bir şifre gönder',
	'Password_updated' => 'Yeni şifreniz oluşturuldu, nasıl aktif hale getireceğinizi öğrenmek için e-posta\'nızı kontrol ediniz.',
	'No_email_match' => 'Bu kullanıcı için verdiğiniz e-posta adresi veritabanındaki ile uyuşmuyor.',
	'New_password_activation' => 'Yeni şifre etkinleştirme',
	'Password_activated' => 'Hesabınız yeniden aktif hale getirilmiştir. Oturum açmak için, aldığınız e-posta\'da ki verilen şifreyi kullanın lütfen.',

	'Send_email_msg' => 'E-posta iletisi gönderin',
	...
	'CC_email' => 'Kendime bu e-postanın bir kopyasını gönder',
...
// Visual confirmation system strings
	...
	'CONFIRM_CODE_IMPAIRED' => 'Eğer görme engelli ya da başka türlü bu kodu okuyamıyorsanız yardım için %sYönetici%s ile iletişim kurunuz.',
	'CONFIRM_CODE' => 'Onay kodu',
	'CONFIRM_CODE_EXPLAIN' => 'Gördüğünüz kodu tam olarak yazın. Hiç SIFIR yoktur.',

// Memberlist
	'Select_sort_method' => 'Sıralama yöntemini seçin',
	'Sort' => 'Sıralama',
	'SORT_TOP_TEN' => 'En İyi On Yazarlar',
	'SORT_JOINED' => 'Katılım Tarihi',
	'SORT_USERNAME' => 'Kullanıcı Adı',
	'SORT_LOCATION' => 'Yer',
	'SORT_POSTS' => 'Toplam mesajlar',
	'SORT_EMAIL' => 'E-Posta',
	'SORT_WEBSITE' => 'Web Site',
...
// Group control panel
	...
	'Group_Moderator' => 'Grup Moderatör',
	'Pending_members' => 'Bekleyen Üyeler',
	...
	'View_Information' => 'Bilgilerini Görüntüle',

// Search
	'Search_query' => 'Arama Sorgusu',
	'Search_options' => 'Arama Seçenekleri',

	'Search_keywords' => 'Anahtar Kelimeler İçin Ara',
	...
	'Search_author' => 'Yazar İçin Ara',
	'Search_author_explain' => 'Kısmi eşleşmeler için * işaretini joker olarak kullanabilirsiniz',
	'Search_author_topic_starter' => 'Yanlızca bu yazarın başlattığı konuları ara',

	'Search_for_any' => 'Girilen herhangi bir terim veya sorguyu kullanarak ara',
	'Search_for_all' => 'Bütün terimler için ara',
	'Search_title_msg' => 'Konu başlığı ve mesaj metninde ara',
	'Search_title_only' => 'Sadece konu başlığında ara',
	...
	'Display_results' => 'Görüntülenecek sonuclar',
	'All_available' => 'Mevcut hepsi',
	'No_searchable_forums' => 'Bu sitedeki herhangi bir forumda arama yapma izniniz yok.',

	'No_search_match' => 'Arama kriterine uygun mesaj yok',
...
// Moderator Control Panel
	'Mod_CP' => 'Moderatör Kontrol Paneli',
...
// 'Description' => 'Topic Description',
	...
	'Today_at' => '<b class="date-today">Bugün</b> ',
	'Yesterday_at' => '<b class="date-yesterday">Dün</b> ',
	'TODAY' => '<b class="date-today">Bugün</b>',
	'YESTERDAY' => '<b class="date-yesterday">Dün</b>',

// Birthday - BEGIN
	'Birthday' => 'Doğum Günü',
	'No_birthday_specify' => 'Belirtilmedi',
	'Age' => 'Yaş',
	'Wrong_birthday_format' => 'Doğum günü biçimi yanlış girilmiş.',
...
// Start add - Gender MOD
	'Gender' => 'Cinsiyet',//used in users profile to display which gender he/she is
	'Male' => 'Bay',
	'Female' => 'Bayan',
	'No_gender_specify' => 'Belirtilmedi',
	'Gender_require' => 'Cinsiyetinizi belirtmeniz bu sitede gereklidir.',
// End add - Gender MOD
...
// TELL A FRIEND
	...
	'TELL_FRIEND_SENDER_USER' => 'Adınız',
	'TELL_FRIEND_SENDER_EMAIL' => 'E-Posta Adresiniz',
...
// Start add - Bin Mod
	...
	'Bin_recycle' => 'Recycle',
// End add - Bin Mod
	'Recent_topics' => 'Son Konular', // Recent Topics
...
// End Edit Notes MOD
	...
	'Recent_today' => 'Bugün',
	'Recent_yesterday' => 'Dün',
	'Recent_last24' => 'Son 24 Saat',
	'Recent_lastweek' => 'Geçen Hafta',
	'Recent_lastXdays' => 'Son %s gün',
	'Recent_last' => 'Last',
	'Recent_days' => 'Days',
...
// END Custom Profile Fields MOD
	...
	'Login_Status' => 'Çevrimiçi Durum',
	'Login_Hidden' => 'Gizli',
	'Login_Visible' => 'Görünür',
	'Login_Default' => 'Varsayılan',
...
// Mighty Gorgon - Nav Links - BEGIN
	'QUICK_LINKS' => 'Menü',
	'MAIN_LINKS' => 'Ana Başlıklar',
	'NEWS_LINKS' => 'Haber',
	'INFO_LINKS' => 'Bilgiler',
	'USERS_LINKS' => 'Kullanıcı Ve Gruplar',
	'SELECT_STYLE' => 'Stil',
	'SELECT_LANG' => 'Dil',
	'RSS_FEEDS' => 'RSS Feeds',
	'SPONSORS_LINKS' => 'Sponsorlar',
	'TOOLS_LINKS' => 'Arçlar',
	'HelpDesk' => 'Yardım Masası',
	'AvatarGenerator' => 'Avatar Yapıcı',
	'DBGenerator' => 'SQL to PHP Yapıcı ',
	...
	'LINK_PROFILE' => 'Profil',
	'LINK_FORUM' => 'Forum',
	'LINK_BOARDRULES' => 'Kurallar',
	'LINK_FAQ' => 'SSS',
	'LINK_SEARCH' => 'Arama',
	'LINK_SITEMAP' => 'Site Haritası',
	'LINK_ALBUM' => 'Albüm',
	'LINK_CALENDAR' => 'Takvim',
	'LINK_DOWNLOADS' => 'İndirmeler',
	'LINK_BOOKMARKS' => 'Bookmarks',
	'LINK_DRAFTS' => 'Taslaklar',
	'LINK_UPLOADED_IMAGES' => 'Kişisel Resimler',
	'LINK_AJAX_SHOUTBOX' => 'Sohbet',
	'LINK_LINKS' => 'Bağlantılar',
	'LINK_CONTACT_US' => 'Bize Ulaşın',
	'LINK_SUDOKU' => 'Sudoku',

	'LINK_NEWS_CAT' => 'Haber Kategorileri',
	'LINK_NEWS_ARC' => 'Haber Arşivi',
	'LINK_NEW_MESSAGES' => 'Yeni Mesajlar',
	'LINK_DISPLAY_UNREAD_S' => 'Okunmamış',
	'LINK_DISPLAY_MARKED_S' => 'İşaretli',
	'LINK_DISPLAY_PERMANENT_S' => 'Kalıcı',
	'LINK_DIGESTS' => 'Özetler',

	'LINK_CREDITS' => 'Credits',
	'LINK_REFERERS' => 'HTTP Referers',
	'LINK_VIEWONLINE' => 'Çevrimiçi Kullanıcılar',
	'LINK_STATISTICS' => 'İstatistik',
	'LINK_DELETE_COOKIES' => 'Çerezleri Sil',

	'LINK_MEMBERLIST' => 'Üyeler',
	'LINK_USERGROUPS' => 'Kullanıcı Grupları',
	'LINK_RANKS' => 'Rütbeler',
	'LINK_STAFF' => 'Kadro',
// Mighty Gorgon - Nav Links - END
	...
	'Activity' => 'Oyunlar',
	'Games' => 'Oyunlar',
	'Trohpy' => 'Oyun Kupaları',
	'quick_links_games' => 'Oyun Menüsü',

	'By' => 'Kim Tarafından',
	'No_Icon_Image' => 'Simge Yok',
	'Change_Style' => 'Stil',
	'Change_Lang' => 'Dil',
	'Permissions_List' => 'İzinler Listesi',
	'IP_TEAM' => 'Icy Phoenix Takımı',
...
// New MG - BEGIN
	'Nav_Separator' => '&nbsp;&raquo;&nbsp;',
	'WeatherForecast' => 'Hava Tahmini',
	'ErrorNotFound' => 'Dosya Bulunamadı!',
	'MGC_Users_Online' => 'MGC Çevrimiçi Kullanıcılar',
	'MGC_User_Servertime' => 'Tarih',
	'MGC_User_Nickname' => 'Takma Ad',
	'MGC_User_Server' => 'Sunucu',
	'MGC_User_IP' => 'IP',
	'MGC_User_ID' => 'ID',
	'MGC_User_Client_Version' => 'MGC Sürümü',

	'Country_Flag' => 'Ülke Bayrağı',
	'Select_Country' => 'Ülke Seç',
	'Extra_profile_info' => 'İlave Profil Bilgisi',
// 'Extra_profile_info_explain' => 'You can add extra information about yourself or about your hobbies. You can also add photos. You can use some bbcodes as when you post or make your signature. There is a <b>%d</b> character limit (if 0 then no limit)',
	'Extra_profile_info_explain' => 'Kendiniz yada hobileriniz hakkında bilgilerinizi ekleyebilirsiniz. Ayrıca fotoğraf ekleyebilirsiniz. İmza yaparsanız bbcode kullanabilirsiniz.',
	'Extra_window' => 'Ayrı pencerede aç',
	'Extra_too_long' => 'Eklediğiniz alan çok uzun (En fazla izin verilen harf <b>%d</b>)',
	'UserLike' => 'User likes',
	...
	'UserSport' => 'Spor Takımı',
	'UserMusic' => 'Müzik/Grup',
	'UserNoInfo' => 'Mevcut Bilgi Yok',
	'LAST_SEEN' => 'Son Çevrimiçi',
// New MG - END

// MG CMS - BEGIN
	'CMS_TITLE' => 'CMS',
	'CMS_MANAGEMENT' => 'CMS Yönetimi',
	'CMS_CONFIG' => 'Yapılandırma',
	'CMS_SETTINGS' => 'Ayarlar',
	'CMS_ACP' => 'Bu Sayfayı Düzenle',
	'CUSTOM_PAGE' => 'Özelleştirilmiş Sayfa',
// MG CMS - END
...
// Online list
	'Online_total' => 'Toplam',
	'Online_registered' => 'Kullanıcılar',
	'Online_guests' => 'Konuk',
	'Who_is_Chatting' => 'Sobhetdekiler',
	'Shoutbox_online_explain' => 'Bu veri son otuz saniye içinde aktif olan kullanıcılara dayanmaktadır',
	'Start_Private_Chat' => 'Özel bir sohbet başlatmak için isminin üzerine tıklayınız',
// Chat rooms
	'Shout_rooms' => 'Odalar',
	'Admin_rooms' => 'Tüm odalar',
...
// Ajax Shoutbox - END
	...
	'Contact_us_explain' => 'Bu sayfayı kullanarak bize e-posta gönderebilirsiniz',
	'Session_invalid' => 'Geçersiz Oturum.Formu yeniden gönderin lütfen.',
...
// Moved here from lang_adv_time.php
	'time_mode' => 'Zaman yönetimi',
	'time_mode_text' => 'DST farkı, ülkeniz için yaz saati ve normal süresi arasındaki fark (0 ile 120 dakika arasında, genellikle 60)',
	'time_mode_auto' => 'Otomatik mod...',
	'time_mode_full_pc' => 'Bilgisayarınızın zamanı',
	...
	'time_mode_manual' => 'Manuel mod...',
	'time_mode_dst' => 'DST etkin',
	'time_mode_dst_server' => 'Sunucu tarafından',
	'time_mode_dst_time_lag' => 'DST farkı',
	'time_mode_dst_mn' => 'dk',
	'time_mode_dst_mn_explain' => 'Zamanın dakika olarak kısaltılmış ifadesi',
	'time_mode_timezone' => 'Saat Dilimi',
...
/* lang_.php - END */
	...
	'Email_confirm' => 'E-Posta adresinizi doğrulayın',
	'Email_mismatch' => 'Girdiğiniz E-Posta adresleri eşleşmiyor.',
...
// Resend Activation - BEGIN
	'Resend_activation_email' => 'Tekrar etkinleştirme E-Postası gönder',
...
// Resend Activation - END
	...
	'ShareThisTopic' => 'Bu Konuyu Paylaş',
...
// 'UCP_ZEBRA' => 'Friends &amp; Foes',
	...
	'AJAX_SHOUTBOX' => 'Sohbet',
	'AJAX_SHOUTBOX_PVT' => 'Özel Sohbet',
	'AJAX_SHOUTBOX_PVT_LINK' => 'Bu kullanıcı ile doğrudan sohbet',
	'AJAX_SHOUTBOX_PVT_ALERT' => 'Bir sohbet isteği var',

	// COMMON DB - BEGIN
	'SELECT_SORT_METHOD' => 'Buna göre sırala',
	'ORDER' => 'Sıralama yöntemi',
	'SUBMIT' => 'Gönder',
	'DATE' => 'Tarih',
	'USERID' => 'User ID',
	'USERNAME' => 'Kullanıcı Adı',
